...
class AxisDriver(axis):
    ...
    def setmicrostep(self, nmicrosteps):
        ...
        print nmicrosteps, self.microstepping['M2'], self.microstepping[
            'M1'], self.microstepping['M0']
        pass
...
class mount:
    def __init__(self):
        ...
        if simulation:
            ...
            self.axis1.setMicrostepPIN(RA_ENABLE_PIN, RA_M0_PIN, RA_M1_PIN,
                                       RA_M2_PIN)
            ...
            self.axis2.setMicrostepPIN(DEC_ENABLE_PIN, DEC_M0_PIN, DEC_M1_PIN,
                                       DEC_M2_PIN)
