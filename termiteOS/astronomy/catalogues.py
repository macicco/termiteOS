...
"""
	ngc=[]
	def __init__(self):
		hdulist = pyfits.open(data_path+"ngc2000.fits")
		desc=hdulist[2].data
...
"""
	...
	def __init__(self):
		hdulist = pyfits.open(data_path+"cross_index.fits")
...
#Data from stellarium 0.8 sources
		fi=open(data_path+'constellationship.fab')
		p=[]
		for l in fi.readlines():
			r=[]
			for f in l.split():
...
"""
	...
	IDs=set()
	def __init__(self):
		self.readfile(data_path+"hip2.dat")
