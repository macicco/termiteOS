...
def runcostellation(name, port, parent_host='', parent_port=False):
    s = costellation(name, port, parent_host, parent_port)
    try:
        s.run()
    except:
        s.end()
...
if __name__ == '__main__':
        runcostellation('costellation',5001,'localhost',5000)
